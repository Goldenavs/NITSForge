...
export function AuthSidebar() {
  ...
  return (
    <div className="w-full lg:w-[30%] min-h-screen lg:h-screen lg:sticky top-0 flex flex-col justify-center px-6 lg:px-10 py-16 lg:py-0 bg-surface/90 backdrop-blur-3xl border-b lg:border-b-0 lg:border-r border-borderline z-20 shadow-[20px_0_40px_rgba(0,0,0,0.05)] transition-colors duration-500 shrink-0">
      <motion.div 
        initial="hidden" 
        animate="visible" 
